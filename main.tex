...
% TODO
% author:
\newcommand{\FirstNameAuthor}{Adrian}
\newcommand{\SurnameAuthor}{Bednorz}
\newcommand{\IdAuthor}{ab306018}  % (remove $\langle$ and $\rangle)
...
\newcommand{\Supervisor}{dr inż. Alina Momot}  % supervisor (remove $\langle$ and $\rangle)
\newcommand{\Title}{Desktop application supporting learning of stereometry}
\newcommand{\TitleAlt}{Aplikacja na komputer stacjonarny wspomagająca naukę stereometrii}
\newcommand{\Program}{Informatics}
\newcommand{\Specialisation}{Computer Graphics and Software} % your specialisation (remove $\langle$ and $\rangle)
\newcommand{\Departament}{Department of Applied Informatics} % your supervisor's departament (remove $\langle$ and $\rangle)

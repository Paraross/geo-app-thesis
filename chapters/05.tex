...
The structure of the scene is similiar to the one in figure \ref{simple_scene}.
...
\begin{itemize}
    \item \textit{TaskFloatValue} represents a task parameter.
    ...
    \item \textit{Step} represents a single task step.
    \item \textit{Task} is the base class for all tasks.
    \item \textit{CubeTaskBase} is the base class of \textit{CubeTask} and \textit{CubeTaskMediumPrecision}.
    \item \textit{CubeTask} corresponds to the \textit{Cube} task.
    \item \textit{CubeTaskMediumPrecision} corresponds to the \textit{Cube With Decimal Digits} task.
    \item \textit{PrismTaskBase} is the base class of \textit{PrismTask} and \textit{PrismTaskMediumPrecision}.
    \item \textit{PrismTask} corresponds to the \textit{Prism} task.
    \item \textit{PrismTaskMediumPrecision} corresponds to the \textit{Prism With Decimal Digits} task.
    \item \textit{CuboidTask} corresponds to the \textit{Cuboid} task.
    \item \textit{HexagonalPyramidTask} corresponds to the \textit{Hexagonal Pyramid} task.
    \item \textit{PyramidTask} corresponds to the \textit{Pyramid} task.
    \item \textit{PyramidAreaTask} corresponds to the \textit{Pyramid Area} task.
        It features the same parameters but overrides the \texttt{steps} method.
    \item \textit{StackedCubesTask} corresponds to the \textit{Stacked Cubes} task.
\end{itemize}
...
The \texttt{VBoxContainer} container lays out its children vertically.

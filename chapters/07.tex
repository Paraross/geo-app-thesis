...
This made it a suitable platform for developing an educational application with 3D rendering capabilites.
...
Classes were refactored several times to accomodate for changing requirements.

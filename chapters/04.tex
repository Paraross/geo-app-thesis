...
\begin{itemize}
    \item The \textbf{Explore tasks} button takes the user to the \textit{Task exploration} module,
    \item The \textbf{Solve tasks} button takes the user to the \textit{Task solving} module,
    \item The \textbf{Playground} button takes the user to the \textit{Playground} module,
...
The 3D view is a part of the \textit{Task exploration}, \textit{Task solving} and \textit{Playground} modules.
...
In the \textit{Playground} module, the label also contains the name of the vertex.
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{graf/3d_view_task}
    \caption{The 3D view as seen in the \textit{Task exploration} and \textit{Task solving} modules.}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{graf/3d_view_task_label}
    \caption{The 3D view as seen in the \textit{Task exploration} and \textit{Task solving} modules. The informational labels are visible}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{graf/3d_view_play}
    \caption{The 3D view as seen in the \textit{Playground} module.}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{graf/3d_view_play_label}
    \caption{The 3D view as seen in the \textit{Playground} module. The informational labels are visible}
\end{figure}
...
They can be created in the \textit{Playground} module.
...
% TODO: tu czy w specyfikacji wewnetrznej
% Polyhedron files store data in the JSON (JavaScript Object Notation) format.
...
With all settings set to default values, the \textbf{settings.cfg} has the following content:

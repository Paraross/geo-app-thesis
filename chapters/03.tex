...
Godot\footnote{\url{https://godotengine.org}} is a cross-platform, free and open-source (FOSS) game engine \cite{godot_docs}.
It is designed to create 2D (two-dimensional) and 3D (three-dimensional) games mainly for the PC (personal computer), mobile, and web platforms.

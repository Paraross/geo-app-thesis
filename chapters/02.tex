...
The 3D Calculator by GeoGebra is an extensive application which provides many tools for exploring 3D geometry.
...
Cabri 3D and Cabri Express are 2 applications for learning three-dimensional geometry developed by Cabri.
...
Shapes 3D Geometry Learning and Shapes 3D Geometry Drawing are two similar applications whose main feature is viewing solids.
...
% NOTE: żeby vimtex nie narzekał na pustą bibliografię
\cite{bib:article}

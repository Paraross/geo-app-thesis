...
A pyramid is a polyhedron consisting of one polygonal base face connected to a point, called the apex.
...
The user interface has an outdated look and has some bugs when running on a system with multiple displays.

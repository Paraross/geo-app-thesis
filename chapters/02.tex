...
A right prism with a rectangular base is also called a \emph{cuboid}.
...
\begin{split}
    ...
    & = \frac{1}{2} s (\frac{1}{2} s \tan (\frac{n-2}{n}90^{\circ})) n \\
    & = \frac{1}{4} s^2 \tan (\frac{n-2}{n}90^{\circ}) n
\end{split}
\end{equation}
...
\begin{split}
    A  & = A_{B} + A_{L} \\
    & = \frac{1}{4} s^2 \tan (\frac{n-2}{n}90^{\circ}) n + \frac{s \sqrt{{h_{B}}^2 + h^2}}{2} n \\
    & = \frac{1}{2} s n (\frac{1}{2} s \tan (\frac{n-2}{n}90^{\circ}) + \sqrt{{h_{B}}^2 + h^2})
\end{split}
\end{equation}
